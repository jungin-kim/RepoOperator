...
FORBIDDEN_VISIBLE_MARKERS = ("Work log", "Technical Log", "hidden reasoning", "<think>")
...
TRACE_SCENARIOS: dict[str, TraceScenario] = {
    "simple_project_summary": TraceScenario(
        ...
        final_response_contract={
            ...
            "must_not_include": list(FORBIDDEN_VISIBLE_MARKERS),
    ...
    "local_only_no_web": TraceScenario(
        ...
        final_response_contract={
            ...
            "must_not_include": [*FORBIDDEN_VISIBLE_MARKERS, "https://"],
            "claims_files_applied": False,
        },
    ),
